// Imported from https://github.com/swcarpentry/git-novice/blob/967bc0b38826039f6554845248c8c294ebff1f56/episodes/03-create.md
...
Then we tell Git to make `recipes` a #link("../learners/reference.md#repository")[repository] -- a place where Git can store versions of our files:

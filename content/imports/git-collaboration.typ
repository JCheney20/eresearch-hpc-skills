...
#box(image("fig/github-add-collaborators.png"))

To accept access to the Owner's repo, the Collaborator needs to go to #link("https://github.com/notifications") or check for email notification. Once there she can accept access to the Owner's repo.
...
#box(image("fig/github-collaboration.svg"))
...
Then push the change to the #emph[Owner's repository] on GitHub:

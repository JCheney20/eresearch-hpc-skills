// Imported from https://github.com/swcarpentry/git-novice/blob/967bc0b38826039f6554845248c8c294ebff1f56/episodes/02-setup.md
...
Please use your own name and email address instead of Alfredo's. This user name and email will be associated with your subsequent Git activity, which means that any changes pushed to #link("https://github.com/")[GitHub];, #link("https://bitbucket.org/")[BitBucket];, #link("https://gitlab.com/")[GitLab] or another Git host server after this lesson will include this information.

For this lesson, we will be interacting with #link("https://github.com/")[GitHub] and so the email address used should be the same as the one used when setting up your GitHub account. If you are concerned about privacy, please review #link("https://help.github.com/articles/keeping-your-email-address-private/")[GitHub's instructions for keeping your email address private];.

#block[
== Keeping your email private
<keeping-your-email-private>
If you elect to use a private email address with GitHub, then use GitHub's no-reply email address for the `user.email` value. It looks like `ID+username@users.noreply.github.com`. You can look up your own address in your GitHub #link("https://github.com/settings/emails")[email settings];.

]
#block[
== Line Endings
<line-endings>
As with other keys, when you press Enter or ↵ or on Macs, Return on your keyboard, your computer encodes this input as a character. Different operating systems use different character(s) to represent the end of a line. (You may also hear these referred to as newlines or line breaks.) Because Git uses these characters to compare files, it may cause unexpected issues when editing a file on different machines. Though it is beyond the scope of this lesson, you can read more about this issue #link("https://www.git-scm.com/book/en/v2/Customizing-Git-Git-Configuration#_core_autocrlf")[in the Pro Git book];.
...
#figure(
  align(center)[#table(
    columns: (27.91%, 72.09%),
    align: (left,left,),
    table.header([Editor], [Configuration command],),
    table.hline(),
...
== Proxy
<proxy>
In some networks you need to use a #link("https://en.wikipedia.org/wiki/Proxy_server")[proxy];. If this is the case, you may also need to tell Git about the proxy:
